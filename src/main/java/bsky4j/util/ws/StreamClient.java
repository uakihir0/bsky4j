...
import bsky4j.util.ws.callback.ClosedCallback;
import bsky4j.util.ws.callback.ErrorCallback;
import bsky4j.util.ws.callback.EventCallback;
import bsky4j.util.ws.callback.OpenedCallback;
